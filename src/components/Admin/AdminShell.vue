...
import { ref } from 'vue';
import { Book, FileText, Image, LogOut, Menu, User, X } from 'lucide-vue-next';
...
const navItems = [
  ...
  { id: 'project', label: 'Projects', href: '/admin/project', Icon: Image },
  { id: 'case_study', label: 'Case Studies', href: '/admin/case_study', Icon: File },
] as const;
...
<template>
  ...
  <div class="flex-1 flex flex-col min-h-screen md:ml-64">
    <header class="h-16 border-b border-neutral-800 bg-neutral-900 flex items-center justify-between px-4 md:px-6 sticky top-0 z-20">
